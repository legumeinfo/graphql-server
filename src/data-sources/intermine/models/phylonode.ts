...
export type InterminePhylonodeResponse =
  IntermineDataResponse<InterminePhylonode>;
export function response2phylonodes(
  response: InterminePhylonodeResponse,
): Array<GraphQLPhylonode> {
