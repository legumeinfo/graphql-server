...
export type IntermineQTLStudyResponse =
  IntermineDataResponse<IntermineQTLStudy>;
export function response2qtlStudies(
  response: IntermineQTLStudyResponse,
): Array<GraphQLQTLStudy> {
