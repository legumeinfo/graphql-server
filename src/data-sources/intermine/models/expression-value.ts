...
export const intermineExpressionValueSort =
  'ExpressionValue.sample.primaryIdentifier';
export type IntermineExpressionValue = [number, string, string];
...
export type IntermineExpressionValueResponse =
  IntermineDataResponse<IntermineExpressionValue>;
export function response2expressionValues(
  response: IntermineExpressionValueResponse,
): Array<GraphQLExpressionValue> {
