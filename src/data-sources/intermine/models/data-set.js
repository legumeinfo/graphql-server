...
// </class>
const intermineDataSetAttributes = [
    'DataSet.id',
    'DataSet.description',
    'DataSet.licence',
    'DataSet.url',
...
const intermineDataSetSort = 'DataSet.name'; // guaranteed not null
...
//   # bioEntities
// }
const graphqlDataSetAttributes = [
    'id',
    'description',
    'licence',
    'url',
...
function response2dataSets(response) {
