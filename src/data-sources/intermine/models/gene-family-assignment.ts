...
export const intermineGeneFamilyAssignmentAttributesFactory = (
...
export const intermineGeneFamilyAssignmentSortFactory = (
  type = 'GeneFamilyAssignment',
) => `${type}.geneFamily.primaryIdentifier`;
export const intermineGeneFamilyAssignmentSort =
...
export type IntermineGeneFamilyAssignmentResponse =
  IntermineDataResponse<IntermineGeneFamilyAssignment>;
export function response2geneFamilyAssignments(
  response: IntermineGeneFamilyAssignmentResponse,
): Array<GraphQLGeneFamilyAssignment> {
