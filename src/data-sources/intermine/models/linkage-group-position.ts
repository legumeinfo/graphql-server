...
export const intermineLinkageGroupPositionAttributesFactory = (
...
export const intermineLinkageGroupPositionSortFactory = (
  type = 'LinkageGroupPosition',
) => `${type}.position`;
export const intermineLinkageGroupPositionSort =
  intermineLinkageGroupPositionSortFactory();

export type IntermineLinkageGroupPosition = [number, number, string, string];
...
export type IntermineLinkageGroupPositionResponse =
  IntermineDataResponse<IntermineLinkageGroupPosition>;
export function response2linkageGroupPositions(
  response: IntermineLinkageGroupPositionResponse,
): Array<GraphQLLinkageGroupPosition> {
