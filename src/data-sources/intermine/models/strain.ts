...
export function response2strains(
  response: IntermineStrainResponse,
): Array<GraphQLStrain> {
...
export const intermineStrainDataSetAttributes =
  intermineDataSetAttributesFactory('Strain.dataSets.id');
export const intermineStrainDataSetSort =
  intermineDataSetSortFactory('Strain.dataSets');
