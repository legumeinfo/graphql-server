...
export type InterminePanGenePair = [string, string, string];
...
export type InterminePanGenePairResponse =
  IntermineDataResponse<InterminePanGenePair>;
// converts an Intermine response into an array of GraphQL PanGenePair objects
export function response2panGenePairs(
  response: InterminePanGenePairResponse,
): Array<GraphQLPanGenePair> {
