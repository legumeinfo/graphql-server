...
// </class>
const intermineExpressionSampleAttributes = [
    'ExpressionSample.id',
...
const intermineExpressionSampleSort = 'ExpressionSample.primaryIdentifier';
...
// }
const graphqlExpressionSampleAttributes = [
    'id',
    'identifier',
    'tissue',
    'num',
...
function response2expressionSamples(response) {
...
module.exports = {
    ...
    graphqlExpressionSampleAttributes,
