...
export type InterminePublicationResponse =
  IntermineDataResponse<InterminePublication>;
// converts an Intermine response into an array of GraphQL Publication objects
export function response2publications(
  response: InterminePublicationResponse,
): Array<GraphQLPublication> {
