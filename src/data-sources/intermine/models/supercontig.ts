...
export type IntermineSupercontig = [...IntermineSequenceFeature];
...
export type IntermineSupercontigResponse =
  IntermineDataResponse<IntermineSupercontig>;
// converts an Intermine response into an array of GraphQL Supercontig objects
export function response2supercontigs(
  response: IntermineSupercontigResponse,
): Array<GraphQLSupercontig> {
