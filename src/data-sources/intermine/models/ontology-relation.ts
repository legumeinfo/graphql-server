...
export const intermineOntologyRelationAttributesFactory = (
  type = 'OntologyTermRelation',
) => [
  `${type}.id`,
  `${type}.redundant`,
  `${type}.direct`,
...
export const intermineOntologyRelationSortFactory = (
  type = 'OntologyTermRelation',
) => `${type}.id`;

export const intermineOntologyRelationSort =
...
export type IntermineOntologyRelationResponse =
  IntermineDataResponse<IntermineOntologyRelation>;

export function response2ontologyRelations(
  response: IntermineOntologyRelationResponse,
): Array<GraphQLOntologyRelation> {
