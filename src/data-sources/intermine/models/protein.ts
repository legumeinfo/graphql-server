...
export function response2proteins(
  response: IntermineProteinResponse,
): Array<GraphQLProtein> {
...
export const intermineProteinGeneFamilyAssignmentsSort =
  intermineGeneFamilyAssignmentSortFactory('Protein.geneFamilyAssignments');
