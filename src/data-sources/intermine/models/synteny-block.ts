...
export type IntermineSyntenyBlock = [...IntermineAnnotatable, number];
...
export type IntermineSyntenyBlockResponse =
  IntermineDataResponse<IntermineSyntenyBlock>;
// converts an Intermine response into an array of GraphQL SyntenyBlock objects
export function response2syntenyBlocks(
  response: IntermineSyntenyBlockResponse,
): Array<GraphQLSyntenyBlock> {
