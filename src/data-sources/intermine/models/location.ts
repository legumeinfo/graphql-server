...
export type IntermineLocationResponse =
  IntermineDataResponse<IntermineLocationObject>;
// converts an Intermine jsonobjects response into an array of GraphQL Location objects
export function response2locations(
  response: IntermineLocationResponse,
): Array<GraphQLLocation> {
  const jsonResponse = objectsResponse2response(
    response,
    intermineLocationObjectAttributes,
  );
...
export const intermineLocationDataSetAttributes =
  intermineDataSetAttributesFactory('Location.dataSets');
export const intermineLocationDataSetSort =
  intermineDataSetSortFactory('Location.dataSets');
