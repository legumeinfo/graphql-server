...
export type IntermineExon = [...IntermineSequenceFeature];

export const graphqlExonAttributes = [...graphqlSequenceFeatureAttributes];
...
export function response2exons(
  response: IntermineExonResponse,
): Array<GraphQLExon> {
