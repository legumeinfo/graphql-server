...
export const intermineSequenceFeatureQueryFormat =
  IntermineQueryFormat.JSON_OBJECTS;

export const intermineSequenceFeatureAttributesFactory = (
...
export const intermineSequenceFeatureSortFactory = (type = 'SequenceFeature') =>
  `${type}.primaryIdentifier`;

export const intermineSequenceFeatureAttributes =
  intermineSequenceFeatureAttributesFactory();

export const intermineSequenceFeatureSort =
  intermineSequenceFeatureSortFactory();

export const intermineOverlappingFeatureAttributes =
  intermineSequenceFeatureAttributesFactory('SequenceFeature.overlapping');

export const intermineOverlappingFeatureSort =
  intermineSequenceFeatureSortFactory('SequenceFeature.overlapping');

export const intermineSequenceFeatureChildFeatureAttributes =
  intermineSequenceFeatureAttributesFactory('SequenceFeature.childFeatures');

export const intermineSequenceFeatureChildFeatureSort =
  intermineSequenceFeatureSortFactory('SequenceFeature.childFeatures');
...
export const intermineSequenceFeatureObjectAttributesFactory = (
  type = 'SequenceFeature',
) => [
...
export const intermineSequenceFeatureObjectAttributes =
...
export type IntermineSequenceFeatureResponse =
  IntermineDataResponse<IntermineSequenceFeatureObject>;
// converts an Intermine jsonobjects response into an array of GraphQL SequenceFeature objects
export function response2sequenceFeatures(
  response: IntermineSequenceFeatureResponse,
): Array<GraphQLSequenceFeature> {
  const jsonResponse = objectsResponse2response(
    response,
    intermineSequenceFeatureObjectAttributes,
  );
