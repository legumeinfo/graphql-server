...
export type IntermineGeneFamilyResponse =
  IntermineDataResponse<IntermineGeneFamily>;
export function response2geneFamilies(
  response: IntermineGeneFamilyResponse,
): Array<GraphQLGeneFamily> {
