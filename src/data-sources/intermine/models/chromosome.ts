...
export type IntermineChromosome = [...IntermineSequenceFeature];
...
export type IntermineChromosomeResponse =
  IntermineDataResponse<IntermineChromosome>;
// converts an Intermine response into an array of GraphQL Chromosome objects
export function response2chromosomes(
  response: IntermineChromosomeResponse,
): Array<GraphQLChromosome> {
