...
export type GraphQLTranscript = GraphQLMRNA;
...
export const intermineTranscriptSortFactory = (type = 'Transcript') =>
...
export const intermineTranscriptObjectAttributesFactory = (
  type = 'Transcript',
) => [
...
export const intermineTranscriptObjectAttributes =
  intermineTranscriptObjectAttributesFactory();

export type IntermineTranscript = [...IntermineSequenceFeature, string, string];
...
export type IntermineTranscriptResponse =
...
export function response2transcripts(
  response: IntermineTranscriptResponse,
): Array<GraphQLTranscript> {
  const jsonResponse = objectsResponse2response(
    response,
    intermineTranscriptObjectAttributes,
  );
