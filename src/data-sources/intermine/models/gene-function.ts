...
export type IntermineGeneFunctionResponse =
  IntermineDataResponse<IntermineGeneFunction>;
export function response2genefunctions(
  response: IntermineGeneFunctionResponse,
): Array<GraphQLGeneFunction> {
  return response2graphqlObjects(response, graphqlGeneFunctionAttributes);
}

export const intermineGeneFunctionGenesAttributes =
  intermineGeneAttributesFactory('GeneFunction.genes');
export const intermineGeneFunctionGenesSort =
  intermineGeneSortFactory('GeneFunction.genes');
export const intermineGeneFunctionTraitsAttributes =
  intermineTraitAttributesFactory('GeneFunction.traits');
export const intermineGeneFunctionTraitsSort = intermineTraitSortFactory(
  'GeneFunction.traits',
);
