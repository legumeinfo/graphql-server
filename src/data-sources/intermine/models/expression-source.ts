...
export const intermineExpressionSourceSort =
...
export type IntermineExpressionSourceResponse =
  IntermineDataResponse<IntermineExpressionSource>;
export function response2expressionSources(
  response: IntermineExpressionSourceResponse,
): Array<GraphQLExpressionSource> {
