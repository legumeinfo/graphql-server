...
async function getOntologyTerms(
  pathQuery: string,
...
export async function getOntologyTermsForTrait(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLOntologyTerm>> {
...
export async function getParentsForOntologyTerm(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLOntologyTerm>> {
...
export async function getParentsForSequenceOntologyTerm(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLOntologyTerm>> {
...
export async function getCrossReferencesForOntologyTerm(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLOntologyTerm>> {
  const constraints = [intermineConstraint('OntologyTerm.id', '=', id)];
