...
export async function getIntronsForGene(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLIntron>> {
...
export async function getIntronsForTranscript(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLIntron>> {
