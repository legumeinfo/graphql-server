...
async function getProteinDomains(pathQuery: string, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLProteinDomain>> {
    // get the data
    ...
    const pageInfoPromise = this.pathQuery(pathQuery, {summaryPath: 'ProteinDomain.id'})
