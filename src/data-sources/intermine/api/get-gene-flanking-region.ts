...
export async function getGeneFlankingRegion(
  identifier: string,
  ...
  return this.pathQuery(query)
    .then((response: IntermineGeneFlankingRegionResponse) =>
    ...
    .then((geneFlankingRegion: GraphQLGeneFlankingRegion) => ({
      data: geneFlankingRegion,
    }));
}
