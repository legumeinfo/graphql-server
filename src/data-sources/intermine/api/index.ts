...
import {getSynonymsForGeneFunction} from './get-gene-function-synonyms.js';
// genetic map
...
// Restore proper typeof typing per f870031, with genefunction additions
export declare class ApiMixinInterface {
  ...
  // gene functions
  searchGeneFunctions: typeof searchGeneFunctions;
  getSynonymsForGeneFunction: typeof getSynonymsForGeneFunction;
  // genetic map
  ...
  getGWASForTrait: typeof getGWASForTrait;
  ...
  getTraitsForGeneFunction: typeof getTraitsForGeneFunction;
...
export const ApiMixin = <T extends ApiBaseConstructor<IntermineServer>>(
  ...
  class ApiMixinClass extends superClass {
    ...
    getSynonymsForGeneFunction = getSynonymsForGeneFunction;
    // genetic map
