...
async function getProteins(pathQuery: string, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLProtein>> {
    // get the data
    ...
    const pageInfoPromise = this.pathQuery(pathQuery, {summaryPath: 'Protein.id'})
