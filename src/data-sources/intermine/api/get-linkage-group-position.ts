...
export async function getLinkageGroupPosition(
  id: number,
  ...
  return this.pathQuery(query)
    .then((response: IntermineLinkageGroupPositionResponse) =>
      response2linkageGroupPositions(response),
    )
    ...
    .then((linkageGroupPosition: GraphQLLinkageGroupPosition) => ({
      data: linkageGroupPosition,
    }));
}
