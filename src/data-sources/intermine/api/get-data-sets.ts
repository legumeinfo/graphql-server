...
async function getDataSets(pathQuery: string, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLDataSet>> {
    // get the data
    ...
    const pageInfoPromise = this.pathQuery(pathQuery, {summaryPath: 'DataSet.id'})
...
export async function getDataSetsForLocation(id: number, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLDataSet>> {
...
export async function getDataSetsForOntology(id: number, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLDataSet>> {
...
export async function getDataSetsForOntologyAnnotation(id: number, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLDataSet>> {
    ...
    // publication may be null
    const joins = [intermineJoin('OntologyAnnotation.dataSets.publication', 'OUTER')];
    const query = interminePathQuery(
        intermineOntologyAnnotationDataSetAttributes,
        intermineOntologyAnnotationDataSetSort,
        constraints,
...
export async function getDataSetsForOntologyTerm(id: number, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLDataSet>> {
...
export async function getDataSetsForOrganism(id: number, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLDataSet>> {
...
export async function getDataSetsForStrain(id: number, { page, pageSize }: PaginationOptions): Promise<ApiResponse<GraphQLDataSet>> {
