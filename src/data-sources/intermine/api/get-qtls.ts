...
export async function getQTLsForLinkageGroup(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLQTL>> {
...
export async function getQTLsForGeneticMarker(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLQTL>> {
...
export async function getQTLsForQTLStudy(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLQTL>> {
...
export async function getQTLsForTrait(
  id: number,
  {page, pageSize}: PaginationOptions,
): Promise<ApiResponse<GraphQLQTL>> {
