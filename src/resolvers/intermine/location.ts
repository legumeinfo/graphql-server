    ...
    feature: async (location, _, {dataSources}) => {
      ...
      switch (featureClass) {
        ...
        case 'GeneFlankingRegion':
          request =
            dataSources[sourceName].getGeneFlankingRegion(featureIdentifier);
          break;
        case 'GeneticMarker':
        ...
        case 'IntergenicRegion':
          request =
            dataSources[sourceName].getIntergenicRegion(featureIdentifier);
          break;
        case 'Intron':
        ...
        case 'SyntenicRegion':
          request =
            dataSources[sourceName].getSyntenicRegion(featureIdentifier);
          break;
        case 'Transcript':
      ...
      return request.then(({data: results}) => ({
